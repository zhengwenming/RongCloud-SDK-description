...
下面几篇文章分别详细的介绍了融云SDK即时通讯机制和集成步骤，由于国内CSDN博客封杀带有广告性质的文章（其实不是打广告，纯粹的技术分享），所以只能在次发表了。希望大家支持我，谢谢。

...
#欢迎加入iOS开发技术支持群，487599875，进群必须改名（2元付费群，慎入！），群名片格式：城市-iOS-名字，例如广州-iOS-文明。

下面几篇文章分别详细的介绍了融云SDK即时通讯机制和集成步骤，由于国内CSDN博客封杀带有广告性质的文章（其实不是打广告，纯粹的技术分享），所以只能在Github发表了。希望大家支持我，谢谢。

#融入Voip功能的提示：

现在的新SDK用不了Voip了，已经分离出一个CallKit进行收费。如果真的要用voip，智能用2.5.2版本的sdk。下面是引用融云官方的文档原话
...
到此，自定义cell应该没问题了，如果有问题，群里联系我 487599875
